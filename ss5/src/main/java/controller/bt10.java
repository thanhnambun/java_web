...
public class bt10 extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        switch (action) {
            case "add":
                request.getRequestDispatcher("views/bt10/form.jsp").forward(request, response);
                break;
            case "edit":
            ...
            default:
                ...
                request.getRequestDispatcher("views/bt10/contact.jsp").forward(request, response);
        }
    }
