        ...
        if (postIdParam != null) {
            ...
            for (Post p : posts) {
                if (p.getId() == postId) {
                    ...
                    request.getRequestDispatcher("views/bt9/postDetail.jsp").forward(request, response);
                    return;
                }
            }
            ...
            request.getRequestDispatcher("views/bt9/postList.jsp").forward(request, response);
        }
    }
}