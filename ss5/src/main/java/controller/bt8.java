...
public class bt8 extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        switch (action) {
            case "add":
                request.getRequestDispatcher("views/bt8/form.jsp").forward(request, response);
                break;
            case "edit":
            ...
            default:
                ...
                request.getRequestDispatcher("views/bt8/taskList.jsp").forward(request, response);
        }
    }
